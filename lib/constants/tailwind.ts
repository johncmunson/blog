...
export const BODY_TEXT_MT = 'mt-1 sm:mt-2 md:mt-3 lg:mt-4'
export const BODY_TEXT_FONT_SIZE = `text-base sm:text-lg md:text-xl lg:text-2xl`
export const BODY_TEXT = `${BODY_TEXT_MT} ${BODY_TEXT_FONT_SIZE}`
