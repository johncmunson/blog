...
- Minimal design, clean typography, and just enough styling to not look like 1996.
...
I don’t like MDX as a spec. It mixes JSX and markdown in a way that, in my opinion, completely undermines what makes markdown elegant in the first place. Markdown should be a lightweight, predictable markup language — not a half-baked templating system.

Instead, I built a pipeline using the unified / remark / rehype ecosystem, wired up exactly the way I want.
...
```bash
git add content/2025-12-04.how-this-blog-works.md
git commit -m "Add blog architecture post"
git push
```
