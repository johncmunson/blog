...
description: This is my no-nonsense and opinionated guide to setting up a Windows/WSL dev environment for productive web development.
---

Developing on Windows/WSL requires a few extra steps to get set up than what you might be used to on a Mac or Linux, and the mental model of how you think about your development environment is a little different. Once you get past the initial setup though, it's really quite nice and you get the benefits of both worlds.

This post will walk you through the steps to get up and running with a Windows/WSL dev environment. Some of the steps are definitely optional and may not apply to you, but things like WSL, Git, and Docker are absolutely required for a smooth WSL development experience. Below is a summary of what is covered:
- WSL
- Git
- Docker
- Fish Shell
